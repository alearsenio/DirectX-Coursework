...
OutputType main(InputType input)
{
    ...
    float4 noisePosition = input.position;
    //move the noise coordinates over time
    noisePosition.y += time * speed;
    noisePosition.z += time * speed;
    //modify the vertex y value
    input.position.y += snoise(noisePosition/ noiseScale) * noiseIntensity;
